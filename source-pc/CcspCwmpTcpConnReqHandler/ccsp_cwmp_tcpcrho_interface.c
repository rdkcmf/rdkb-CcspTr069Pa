...
/**********************************************************************
    ...
    module:	ccsp_cwmp_tcpcrho_interface.c
    ...
    description:
        ...
        general utility functions for CCSP CWMP TCP Connection 
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new CCSP CWMP TCP Connection
        Request Handler object.
